...
@section('title', __('Create Couple Product'))

@section('content')
    <x-forms.post :action="route('admin.couple_product.store')" :enctype="'multipart/form-data'">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create Couple Product')
            </x-slot>
            ...
            <x-slot name="body">
                <div>
                    ...
                    <div class="form-group row">
                        <label for="product1_image" class="col-md-2 col-form-label">@lang('Image 1') (485x515)</label>
                    ...
                    <div class="form-group row">
                        <label for="product2_image" class="col-md-2 col-form-label">@lang('Image 2') (485x515)</label>
                        <div class="form-group">
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create Couple Product')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
