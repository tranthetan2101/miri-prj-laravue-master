...
@section('title', __('Update Combo'))

@section('content')
    <x-forms.patch :action="route('admin.combo.update', $combo)"  :enctype="'multipart/form-data'">
        <x-backend.card>
            <x-slot name="header">
                @lang('Update Combo')
            </x-slot>
            ...
            <x-slot name="body">
                <div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" data-slug="name" id="name" name="name" class="form-control" placeholder="{{ __('Name') }}" value="{{ old('name') ?? $combo->name}}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="sku" placeholder="{{ __('SKU') }}" value="{{ old('sku') ?? $combo->sku}}" maxlength="100" required  class="form-control" />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" data-slug="alias" name="slug" class="form-control" placeholder="{{ __('Slug') }}" value="{{ old('slug') ?? $combo->slug}}" maxlength="255" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('category_id', $categories->pluck('name','id'))->class('form-control')->value(old('category_id') ?? $combo->category_id) }}
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input id="image" class="form-control" type="hidden" name="image" value="{{ $combo->image }}" >
                            <div id="holder" style="margin-top:15px;max-height:150px;">
                                <img onclick="removeImage('image',0)" data-idx="0" title="Click to Remove" style="height: 7rem" src="{{$combo->picture}}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="price" id="price" class="form-control" type="text" value="{{ old('price') ? str_replace('.','',old('price')) : $combo->price }}" />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="discount_price" id="discount_price" class="form-control" type="text" value="{{ old('discount_price') ? str_replace('.','',old('discount_price')) : $combo->discount_price }}" />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="stock" type="number" class="form-control" placeholder="{{ __('Quantity') }}" value="{{ old('stock') ?? $combo->stock }}" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->textarea('description')->attribute('rows', 5)
                                ->class('form-control')->value(old('description') ?? $combo->description) }}
                        </div><!--col-->
                    </div><!--form-group-->

                    <div class="form-group row">
                        <label for="gift_set" class="col-md-2 col-form-label">@lang('Product')</label>

                        <div class="col-md-10">
                            {{ html()->select('product_id')
                                ->options([$combo->item->id => $combo->item->name])
                                ->value($combo->item->id)
                                ->id('product_id')
                                ->class('form-control')}}
                        </div><!--col-->
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Update Combo')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.patch>
@endsection
