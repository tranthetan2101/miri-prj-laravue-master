        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div>
                    ...
                    <div class="form-group row">
                        <label for="images" class="col-md-4 col-form-label">@lang('Images')<br/> (275x395 cho sản phẩn, 590x465 cho combo)</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input maxlength="50" name="origin" id="origin" class="form-control" type="text" value="{{ old('origin') }}" />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input maxlength="50" name="capacity" id="capacity" class="form-control" type="text" value="{{ old('capacity') }}" />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="description_2" class="col-md-2 col-form-label">@lang('Process')</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label for="recommend" class="col-md-2 col-form-label">@lang('Related Product')</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="favorite_flg" id="favorite_flg" class="form-check-input" type="checkbox" value="1" {{ old('active', false) ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="tag_best" id="tag_best" class="form-check-input" type="checkbox" value="1" {{ old('tag_best', false) ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="tag_recommend" id="tag_recommend" class="form-check-input" type="checkbox" value="1" {{ old('tag_recommend', false) ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                                <input name="tag_sale" id="tag_sale" class="form-control" type="text" value="{{ old('tag_sale') }}" />
                        </div>
                    </div><!--form-group-->
