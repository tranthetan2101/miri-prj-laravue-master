<header class="c-header c-header-light c-header-fixed">
    ...
    <a class="c-header-brand d-lg-none" href="#">
        <img width="118" height="46" align="Miri Logo" src="{{ asset('images/miri-logo.svg') }}"/>
    </a>
    ...
    <ul class="c-header-nav d-md-down-none">
        <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{ route('frontend.index') }}">Trang chủ</a></li>
