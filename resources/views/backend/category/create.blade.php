            ...
            <x-slot name="body">
                <div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" data-slug="name" name="name" class="form-control" placeholder="{{ __('Name') }}" value="{{ old('name') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="visible" id="visible" class="form-check-input" type="checkbox" value="1" {{ old('visible', true) ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->
